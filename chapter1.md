...
Statistikas tähistatakse tavaliselt hinnanguid katusemärgi (hat) abil. Näiteks, võib edaspidi kohata tähistust hinnangu üldkogumi keskväärtusele kujul $\hat{\mu} = \bar{x}$.
*** =instructions
