...
Täisarvulise vektori jaoks saab kasutada  `algus:lõpp` meetodit, mis loob vektori täisarvudega alates arvust `algus` kuni arvuni `lõpp`. Kahe järgmise rea tulemused on samad: 
